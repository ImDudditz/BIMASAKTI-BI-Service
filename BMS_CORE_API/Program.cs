    ...
    public class Program
    {
        ...
        private static void EnsureJwtSecret()
        {
            ...
            string[] potentialPaths = new[]
            {
                ...
                Path.Combine(Directory.GetCurrentDirectory(), "BMS-CORE-API", ".env"),
            ...
            if (Directory.Exists(Path.Combine(currentDir, "BMS-CORE-API")))
            {
                targetEnvPath = Path.Combine(currentDir, "BMS-CORE-API", ".env");
            }
            else if (Path.GetFileName(currentDir).Equals("BMS-CORE-API", StringComparison.OrdinalIgnoreCase))
            {
            ...
            else
            {
                ...
                if (Directory.Exists(possibleBackend) && Path.GetFileName(possibleBackend).Equals("BMS-CORE-API", StringComparison.OrdinalIgnoreCase))
                {
