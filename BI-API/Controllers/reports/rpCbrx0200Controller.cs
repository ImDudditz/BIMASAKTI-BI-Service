...
namespace Bimasakti.BiService.Api.Controllers.Reports
{
    [Authorize]
    [ApiController]
    [Route("api/reports/cbrx0200")]
    public class rpCbrx0200Controller : ControllerBase
    {
        private readonly IsvcCbrx0200 _service;
        public rpCbrx0200Controller(IsvcCbrx0200 service) => _service = service;
