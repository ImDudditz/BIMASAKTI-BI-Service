...
namespace Bimasakti.BiService.Api.Controllers.Reports
{
    [Authorize]
    [ApiController]
    [Route("api/reports/lmrx0400")]
    public class rpLmrx0400Controller : ControllerBase
    {
        private readonly IsvcLmrx0400 _service;
        public rpLmrx0400Controller(IsvcLmrx0400 service) => _service = service;
