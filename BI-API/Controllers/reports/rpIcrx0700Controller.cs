...
namespace Bimasakti.BiService.Api.Controllers.Reports
{
    [Authorize]
    [ApiController]
    [Route("api/reports/icrx0700")]
    public class rpIcrx0700Controller : ControllerBase
    {
        private readonly IsvcIcrx0700 _service;
        public rpIcrx0700Controller(IsvcIcrx0700 service) => _service = service;
