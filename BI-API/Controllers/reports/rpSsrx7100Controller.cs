...
namespace Bimasakti.BiService.Api.Controllers.Reports
{
    [Authorize]
    [ApiController]
    [Route("api/reports/ssrx7100")]
    public class rpSsrx7100Controller : ControllerBase
    {
        private readonly IsvcSsrx7100 _service;
        public rpSsrx7100Controller(IsvcSsrx7100 service) => _service = service;
