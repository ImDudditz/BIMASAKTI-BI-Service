...
namespace Bimasakti.BiService.Api.Controllers.Reports
{
    [Authorize]
    [ApiController]
    [Route("api/reports/arrx0100")]
    public class rpArrx0100Controller : ControllerBase
    {
        private readonly IsvcArrx0100 _service;
        public rpArrx0100Controller(IsvcArrx0100 service) => _service = service;
