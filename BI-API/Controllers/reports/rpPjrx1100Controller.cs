...
namespace Bimasakti.BiService.Api.Controllers.Reports
{
    [Authorize]
    [ApiController]
    [Route("api/reports/pjrx1100")]
    public class rpPjrx1100Controller : ControllerBase
    {
        private readonly IsvcPjrx1100 _service;
        public rpPjrx1100Controller(IsvcPjrx1100 service) => _service = service;
