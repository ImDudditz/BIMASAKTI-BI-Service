...
const bimasaktiLogo = new URL('../../../BMS_CORE_API/assets/BMS/img/BMS_logo.png', import.meta.url).href
...
<template>
  <div class="min-h-screen w-full flex items-center justify-center font-sans overflow-hidden relative bg-[#f4f6fa]">
    
    <!-- Fluent Background Blobs for Windows 11 Acrylic Look -->
    <div class="absolute top-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-blue-500/10 blur-[120px] pointer-events-none z-0"></div>
    <div class="absolute bottom-[-10%] left-[-10%] w-[45vw] h-[45vw] rounded-full bg-purple-500/10 blur-[100px] pointer-events-none z-0"></div>
    ...
    <div class="w-full max-w-6xl p-6 md:p-12 flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
      ...
      <div class="flex flex-col items-center md:items-start text-center md:text-left max-w-md animate-fade-in">
        ...
        <h1 class="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter mb-4 leading-tight">
          BIMASAKTI<br><span class="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">BI SERVICE</span>
        </h1>
      ...
      <div class="w-full max-w-[420px] animate-slide-up">
        <div class="bg-white/70 backdrop-blur-xl border border-white/50 rounded-[32px] shadow-2xl p-8 md:p-10 text-slate-800">
          ...
          <form @submit.prevent="handleLogin" class="flex flex-col gap-5">
            ...
            <!-- Error Alert -->
            <div v-if="errorMsg" class="bg-red-50 border border-red-200 text-red-700 text-xs font-bold px-4 py-3 rounded-2xl flex items-center gap-2 animate-bounce">
            ...
            <div class="flex items-center justify-between px-2">
              <label class="flex items-center gap-2 cursor-pointer group">
                <input type="checkbox" class="w-4 h-4 rounded border-slate-300 bg-white text-blue-600 focus:ring-blue-500">
                <span class="text-xs font-bold text-slate-500 group-hover:text-slate-700 transition-colors">Remember Me</span>
              </label>
              <a href="#" class="text-xs font-bold text-slate-500 hover:text-blue-600 underline decoration-slate-200 underline-offset-4 transition-colors">Forgot Password?</a>
            </div>
            ...
            <div class="mt-4 bg-slate-50 rounded-2xl p-4 border border-slate-100">
              <p class="text-[10px] text-center font-bold text-slate-400 leading-relaxed uppercase tracking-wider">
