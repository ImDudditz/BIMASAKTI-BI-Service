      ...
      >
        ...
        <div class="space-y-2">
          ...
          <p class="text-sm text-slate-500 font-medium leading-relaxed">
            You do not have permission to view the Income Statement Report. Please contact your
            ...
            <tbody>
              ...
              <tr class="border-b border-[#cbd5e1] bg-green-50/20">
                ...
                <td
                  ...
                  :class="
                    isNeg(multiReports.current.structure.Revenue.total)
                      ? 'text-red-600'
                      : 'text-black'
                  "
                >
                ...
                <td
                  class="border-r border-[#cbd5e1] px-3 py-2 text-right font-black text-[12px] border-t-[2px] border-t-slate-400 border-b-[4px] border-b-double border-b-slate-400 bg-green-50/10"
                  :class="
                    isNeg(multiReports.current.structure.Expenses.total)
                      ? 'text-red-600'
                      : 'text-black'
                  "
                >
              ...
              <tr class="border-b border-[#cbd5e1] bg-green-50/20 font-black">
                ...
                <template v-for="(header, index) in matrixState.headers" :key="index">
                  ...
                  <td
                    ...
                    :class="
                      isNeg(matrixState.netIncomes[index]) ? 'text-red-600' : 'text-green-600'
                    "
                  >
        ...
        >
          ...
          >
            ...
            >
              <button
                @click="closeModal"
                class="bg-[#107c41] hover:bg-[#0b592e] text-white px-5 py-1.5 rounded text-xs font-bold transition-colors shadow-sm tracking-wide outline-none"
              >
                Close Breakdown
              </button>
            </div>
