...
const fetchUserWidgets = async () => {
  try {
    ...
    dynamicWidgets.value = res.data.filter((w) => w.category === 'Tenant')
  } catch (err) {
          ...
          >
            ...
            <div class="space-y-2">
              ...
              <p class="text-sm text-slate-500 font-medium leading-relaxed">
                You do not have permission to view the Operations Dashboard. Please contact your
